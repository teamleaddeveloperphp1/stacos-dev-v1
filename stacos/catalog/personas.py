...
PERSONAS: tuple[Persona, ...] = (
    ...
    Persona(
        ...
        registrations=(
            ...
            ("LLPIN", ""),
            ("GST", "IN-MH"),
            # Both certificates: PT_EC is the firm's own annual liability, PT_RC
            # is for the tax deducted from its six employees. A small employer
            # holds both, and the two drive completely different filings.
            ("PT_EC", "IN-MH"),
            ("PT_RC", "IN-MH"),
            ("SHOPS_ESTAB", "IN-MH"),
            ("UDYAM", ""),
    ...
    Persona(
        key="food-processor-pb",
        name="Amrit Foods Pvt Ltd",
        description="Punjab food processor: FSSAI-licensed factory, BIS-marked products, 130 staff.",
        entity_type="PVT_LTD",
        facts={
            "aggregate_turnover": 420000000,
            "employee_count": 130,
            "contractor_count": 60,
            "women_employees_count": 55,
        ...
        registrations=(
            ...
            ("ESIC", ""),
            ("PT_RC", "IN-PB"),
            ("FACTORY_LICENCE", "IN-PB"),
            ("PCB_CONSENT", "IN-PB"),
            ("FSSAI", "IN-PB"),
            ("BIS", ""),
            ("LEGAL_METROLOGY", "IN-PB"),
            ("IEC", ""),
            ("UDYAM", ""),
        ),
        premises=(("FACTORY", "IN-PB"), ("REGISTERED_OFFICE", "IN-PB")),
        incorporation_date=date(2014, 2, 26),
        events={"AGM_DATE": date(2026, 9, 24)},
    ),
